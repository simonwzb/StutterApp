...
import 'package:stutter_app/network/dio_cache_interceptors.dart';
import 'package:stutter_app/network/dio_interceptors.dart';
import 'package:stutter_app/network/dio_method.dart';
import 'package:stutter_app/network/dio_token_interceptors.dart';
import 'package:stutter_app/network/dio_transformer.dart';
...
class DioUtil {
  ...
  /// 响应超时时间
  static const int RECEIVE_TIMEOUT = 3 * 60 * 1000;

  /// 请求的URL前缀
  static String BASE_URL = "https://www.getlijin.com";

  //static String BASE_URL = "http://192.168.1.2:3000";
