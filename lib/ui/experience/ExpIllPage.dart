...
class ExpIllPage extends StatefulWidget {
  var parentContext;

  ExpIllPage(this.parentContext);

  @override
  State createState() => _ExpIllPageState();
}

class _ExpIllPageState extends State<ExpIllPage>
    with AutomaticKeepAliveClientMixin<ExpIllPage>, TickerProviderStateMixin {
  @override
  bool get wantKeepAlive => true;

  final webViewKey = GlobalKey<_ExpIllPageState>();
                          ...
                          child: Card(
                            ...
                            child: Column(
                              ...
                              children: [
                                Padding(
                                    padding:
                                        EdgeInsets.fromLTRB(3.5, 3.5, 3.5, 1.5),
                                    child: Text(
                                      res[index]['title'],
                                ...
                                Padding(
                                    padding:
                                        EdgeInsets.fromLTRB(3.5, 0, 3.5, 2.5),
                                    child: Text(
